...
class HybridConvolutionalAutoencoder(nn.Module):      
    def __init__(self):
        ...
        self.decoder = nn.Sequential(                                  
            ...
            nn.ConvTranspose2d(64, 32, 4, stride=2),  #63x63
            nn.BatchNorm2d(32),
            nn.ReLU(inplace=True),            
            
            nn.ConvTranspose2d(32, 1, 3, stride=1),  #63x63
            nn.ReLU(inplace=True),
        )
        # Input Dataset built with images 128x128 
        #super(HybridConvolutionalAutoencoder, self).__init__()
        #self.encoder = nn.Sequential(
        #    nn.Conv2d(1, 32, 3, padding=0, stride=1), #127x127
        #    nn.ReLU(inplace=True),
        #    nn.BatchNorm2d(32),
        #    nn.MaxPool2d(3, 3),            
        ...
        #    nn.Conv2d(128, 256, 3, padding=0, stride=1), #7x7
        #    nn.ReLU(inplace=True), 
        #    nn.BatchNorm2d(256),
            
        #    nn.Conv2d(256, 256, 3, padding=0, stride=1), #6x6
        #    nn.ReLU(inplace=True), 
        #    nn.BatchNorm2d(256),
        #    nn.MaxPool2d(3, 3),            
